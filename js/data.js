    ...
    timeline: [
        {
            ...
            description: "Started as a Project Manager on the Audit Innovation Team and evolved into Scrum Master & Release Manager, overseeing 2 scrum teams and releases across 2 Azure DevOps projects. Building DevOps AI tools (HTML dashboards, wiki integration, and bot workflows) to improve metrics visibility.",
            tags: ["Scrum Master", "Release Management", "Azure DevOps", "SAFe Agile", "Audit Innovation"],
            icon: "chart-line"
        },
        {
            id: 2,
            year: "2017 - 2021",
            // (unchanged data for brevity)
        },
        {
            id: 5,
            year: "2014",
