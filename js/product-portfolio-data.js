...
const productPortfolioData = {
    ...
    mappedProducts: [
        ...
        },
        {
            ...
            productName: "Easy-connect attachment head and adapter",
            company: "Pacific Cycle (Schwinn/Mongoose)",
            period: "2012 - 2014",
            role: "Product Manager & Co-Inventor",
            domain: "Consumer Products",
            productType: "Patented Product (US9759337B2)",
            stage: "Granted Patent",
            users: "Mass retail bicycle accessory customers",
            problem: "Bicycle pumps required different adapters for Schrader vs Presta valves, creating user confusion and friction.",
            delivery: "Co-invented and led commercialization of universal valve adapter with quick-release attachment head mechanism. Patent granted September 2017.",
            outcomes: [
                "Granted US Patent 9,759,337 B2 (Sep 2017)",
                "Enabled tool-free, one-handed pump attachment",
                "Drove differentiated retail product value"
            ],
            evidence: "Google Patents: US9759337B2 - Inventor: Ian Cassiman",
            tags: ["Patent", "Accessories", "Retail", "Innovation"],
            icon: "link",
            patentUrl: "https://patents.google.com/patent/US9759337B2",
            visualIdeas: [
        ...
        },
        {
            ...
            role: "Product Manager & Co-Inventor",
            domain: "Consumer Products",
            productType: "Patent Application (US20140308062A1)",
            stage: "Published Patent Application",
            users: "Retail bicycle accessory customers",
            problem: "Needed modularity across accessory SKUs while reducing portfolio complexity and enabling tool-free attachment.",
            delivery: "Co-invented modular connector system combining mechanical and magnetic forces for quick-attach accessories. Filed April 2014.",
            outcomes: [
                "Published US Patent Application 20140308062A1",
                "Contributed to Walmart-exclusive patented product outcome",
                "Enabled standardized accessory ecosystem"
            ],
            evidence: "Google Patents: US20140308062A1 - Inventor: Ian Cassiman",
            tags: ["Patent", "Modularity", "Walmart", "Innovation"],
            icon: "diagram-project",
            patentUrl: "https://patents.google.com/patent/US20140308062A1",
            visualIdeas: [
